                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        信用等级
                                        <div class="layui-input-inline">
                                            <select name="gongyingshangXinyongdengjiTypesSelectSearch"  style="width: 150px;" id="gongyingshangXinyongdengjiTypesSelectSearch" class="form-control form-control-sm"
