...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        会员标签
                                        <div class="layui-input-inline">
                                            <input type="text" id="huiyuanbiaoqianNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="会员标签" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //会员标签
            var huiyuanbiaoqianNameCell = document.createElement('td');
            huiyuanbiaoqianNameCell.innerHTML = item.huiyuanbiaoqianName;
            row.appendChild(huiyuanbiaoqianNameCell);
