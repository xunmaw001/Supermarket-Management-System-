                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 huiyuanbiaoqianNameDiv">
                                        <label>会员标签</label>
                                        <input style="width: 450px" id="huiyuanbiaoqianName" name="huiyuanbiaoqianName" class="form-control"
                                               placeholder="会员标签">
                                    </div>
