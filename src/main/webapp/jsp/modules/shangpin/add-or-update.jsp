                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpinDanweiDiv">
                                        <label>单位</label>
                                        <input style="width: 450px" id="shangpinDanwei" name="shangpinDanwei" class="form-control"
                                               placeholder="单位">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinNewMoneyDiv">
                                        ...
                                        <input style="width: 450px" id="shangpinNewMoney" name="shangpinNewMoney" class="form-control"
                                               onchange="shangpinNewMoneyChickValue(this)" placeholder="商品售价">
                                    </div>
