...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">商品销售列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="shangpinxiaoshouUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="商品销售单号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( huiyuanNameSearchInput != null){
                if (huiyuanNameSearchInput.val() != null && huiyuanNameSearchInput.val() != '') {
                    searchForm.huiyuanName = $('#huiyuanNameSearch').val();
                            ...
                            //会员标签
            var huiyuanbiaoqianNameSearchInput = $('#huiyuanbiaoqianNameSearch');
            if( huiyuanbiaoqianNameSearchInput != null){
                if (huiyuanbiaoqianNameSearchInput.val() != null && huiyuanbiaoqianNameSearchInput.val() != '') {
                    searchForm.huiyuanbiaoqianName = $('#huiyuanbiaoqianNameSearch').val();
                }
            }
            ...
            //商品销售单号
            var shangpinxiaoshouUuidNumberSearchInput = $('#shangpinxiaoshouUuidNumberSearch');
            if( shangpinxiaoshouUuidNumberSearchInput != null){
                if (shangpinxiaoshouUuidNumberSearchInput.val() != null && shangpinxiaoshouUuidNumberSearchInput.val() != '') {
                    searchForm.shangpinxiaoshouUuidNumber = $('#shangpinxiaoshouUuidNumberSearch').val();
                }
            }
                                    getDataList();
        }
        ...
        function getDataList() {
            http("shangpinxiaoshou/page", "GET", {
                ...
                sort: sortColumn,
                order: sortOrder,
                shangpinxiaoshouDelete: 1,
                //本表的
                shangpinxiaoshouUuidNumber: searchForm.shangpinxiaoshouUuidNumber,
            //级联表的
                huiyuanName: searchForm.huiyuanName,
                huiyuanbiaoqianName: searchForm.huiyuanbiaoqianName,
        ...
        function setDataRow(item, number) {
            ...
            //商品销售单号
            var shangpinxiaoshouUuidNumberCell = document.createElement('td');
            shangpinxiaoshouUuidNumberCell.innerHTML = item.shangpinxiaoshouUuidNumber;
            row.appendChild(shangpinxiaoshouUuidNumberCell);


            //商品销售数量
            var shangpinxiaoshouNumberCell = document.createElement('td');
            shangpinxiaoshouNumberCell.innerHTML = item.shangpinxiaoshouNumber;
            row.appendChild(shangpinxiaoshouNumberCell);


            //销售金额
            var shangpinxiaoshouTruePriceCell = document.createElement('td');
            shangpinxiaoshouTruePriceCell.innerHTML = item.shangpinxiaoshouTruePrice;
            row.appendChild(shangpinxiaoshouTruePriceCell);


            //商品销售时间
            var shangpinxiaoshouTimeCell = document.createElement('td');
            shangpinxiaoshouTimeCell.innerHTML = item.shangpinxiaoshouTime;
            row.appendChild(shangpinxiaoshouTimeCell);
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshangpinxiaoshou", "addshangpinxiaoshou");
            window.location.href = "add-or-update.jsp"
        }
