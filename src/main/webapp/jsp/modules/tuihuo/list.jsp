...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">退货列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="tuihuoUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="退货单号" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //退货单号
            var tuihuoUuidNumberSearchInput = $('#tuihuoUuidNumberSearch');
            if( tuihuoUuidNumberSearchInput != null){
                if (tuihuoUuidNumberSearchInput.val() != null && tuihuoUuidNumberSearchInput.val() != '') {
                    searchForm.tuihuoUuidNumber = $('#tuihuoUuidNumberSearch').val();
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("tuihuo/page", "GET", {
                ...
                tuihuoDelete: 1,
                //本表的
                tuihuoUuidNumber: searchForm.tuihuoUuidNumber,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //退货单号
            var tuihuoUuidNumberCell = document.createElement('td');
            tuihuoUuidNumberCell.innerHTML = item.tuihuoUuidNumber;
            row.appendChild(tuihuoUuidNumberCell);


            //退货数量
            var tuihuoNumberCell = document.createElement('td');
            tuihuoNumberCell.innerHTML = item.tuihuoNumber;
            row.appendChild(tuihuoNumberCell);


            //退货时间
            var tuihuoTimeCell = document.createElement('td');
            tuihuoTimeCell.innerHTML = item.tuihuoTime;
            row.appendChild(tuihuoTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("tuihuo/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addtuihuo", "addtuihuo");
            window.location.href = "add-or-update.jsp"
        }
